...
void ACalibratedCamera::initialize_color_assist(FString primaries_filename, FString plates_filename, float start_threshold, int start_step_size, TArray<FTransform>& all_plates_transform) {
